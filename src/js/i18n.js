...
const TRANSLATIONS = {
    zh: {
        ...
        'modal.lost.detail_loc.label': '详细位置 (选填)',
    ...
    ko: {
        ...
        'modal.lost.detail_loc.label': '상세 위치 (선택)',
        ...
        'modal.lost.vehicle.no': '차량 번호 (선택)',
    ...
    en: {
        ...
        'modal.lost.detail_loc.label': 'Detailed Location (Optional)',
        ...
        'modal.lost.vehicle.no': 'License Plate (Optional)',
