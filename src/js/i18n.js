...
const TRANSLATIONS = {
    zh: {
        ...
        'lost.success.marquee': '📢 [{date}] {region}的{id}成功收回了 {item}！',
    ...
    ko: {
        ...
        'lost.success.marquee': '📢 [{date}] {region}의 {id}님이 {item}을(를) 무사히 돌려받으셨습니다!',
    ...
    en: {
        ...
        'lost.success.marquee': '📢 [{date}] {id} from {region} successfully recovered their {item}!',
