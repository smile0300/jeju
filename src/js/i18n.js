...
const TRANSLATIONS = {
    zh: {
        ...
        'lost.notice.prog2': '<b>[保管中]</b> 物品已找到，正在安全保管。',
        'lost.notice.prog3': '<b>[配送/完成]</b> 物品正在交接（配送）给失主，或已归还完成。',
    ...
    ko: {
        ...
        'lost.notice.prog1': '<b>[찾는 중]</b> 분실물이 접수되어 매칭을 기다리는 상태입니다.',
        'lost.notice.prog2': '<b>[보관 중]</b> 물건을 확보하여 안전하게 보관소에 보관하고 있습니다.',
        'lost.notice.prog3': '<b>[배송/완료]</b> 소유자에게 배송(인계) 중이거나 반환이 완료된 상태입니다.',
