...
const TRANSLATIONS = {
    zh: {
        ...
        'nav.airport':    '机场信息',
        'nav.lost':       '失物招领',
        'lost.home.search':   '失物查询',
        'lost.home.status':   '进度查询',
        'lost.home.register': '失物登记',
        'lost.home.proxy':    '代领服务',
        'lost.home.back':     '返回',
        'nav.festival':   '节日活动',
        'nav.reward':     '红　包',
        'nav.food':       '济州美食',
        'nav.course':     '推荐路线',
        'nav.reservation': '预约申请',
        'badge.maintenance': '维护中',

        // ── 예약신청 ──
        'res.type.beauty':     '美发/美甲',
        'res.type.restaurant': '餐厅',
        'res.type.activity':   '休闲活动',
        'res.type.skin':       '皮肤科',
        'res.type.cloth':      '服装租赁',
        'res.type.snap':       '快照摄影',
        'res.type.rental':     '物品租借',
        'res.type.other':      '其他',
        'res.back':            '返回',
        ...
        'lost.report.heic_err': '不支持 iPhone 的高效(HEIC)照片格式。\\n请在相册中截图后，上传截图文件(JPEG/PNG)！',
        ...
        'proxy.modal.item_name':       '物品名称',
        'proxy.modal.item_name_opt':   '物品名称 (选填)',
        'proxy.modal.item_photo_opt':  '物品照片 (选填)',
        'proxy.modal.name':            '申请人姓名 (同护照)',
        'proxy.modal.name.ph':         '请输入姓名',
        'proxy.modal.contact':         '联系方式 (微信ID或电话)',
        'proxy.modal.contact.ph':      '请输入联系方式',
        'proxy.modal.passport':        '护照照片',
        'proxy.modal.item_photo':      '物品照片',
        'proxy.modal.reservation':     '酒店预订记录截图',
        'proxy.modal.room_num':        '入住房间号 (选填)',
        'proxy.modal.room_num.ph':     '例如：301房',
        'proxy.modal.mgmt_num':        '受理/管理编号',
        'proxy.modal.mgmt_num.ph':     '请输入管理编号',
        'proxy.modal.vehicle_info':    '车牌号或司机联系方式',
        'proxy.modal.vehicle_info.ph': '例如：车牌号或手机号',
        'proxy.modal.board_time':      '大致上下车时间 (选填)',
        'proxy.modal.board_time.ph':   '例如：下午2点左右',
        'proxy.modal.location_detail': '保管场所详细说明',
        'proxy.modal.location_detail.ph':'请详细说明地点和情况',
        'proxy.modal.wechat':          '微信 ID',
        'proxy.modal.wechat.desc':     '我们将通过微信与您联系并代领。',
        'proxy.modal.wechat.ph':       '请输入微信号',
        'proxy.modal.address':         '最终收货地址',
        'proxy.modal.address.ph':      '请输入酒店名称、房间号或返程航班等',
        'proxy.modal.submit':          '提交代领申请',
        'proxy.modal.privacy_notice':  '根据代领标准的加强，护照照片为必填项。应酒店要求，未附护照照片将无法代领。您的个人信息将在物品交付后立即删除。',
        'proxy.modal.step1.title':     '📍 我们应该去哪里取件？',
        'proxy.modal.step1.desc':      '请选择物品存放的地点。',
        'proxy.modal.step2.title':     '📄 请填写取件所需信息。',
        'proxy.modal.step3.title':     '📬 我们应该送到哪里？',
        'lost.modal.cta': '委托寻找我的失物',
        'lost.modal.cta_report': '申报遗失',
        'lost.modal.cta_proxy': '代领申请',
        'lost.notice.title': '失物招领中心使用指南',
        'lost.notice.howto': '使用方法',
        'lost.notice.how1': '选择上方的<b>地区</b>、<b>分类</b>和<b>日期</b>，点击搜索按钮即可查看当天的失物记录。',
        'lost.notice.how2': '如果没有找到您的物品，请点击上方的<b>+ 报失登记</b>按钮。<u><b>我们将立即协助您联系遗失地点或相关企业。</b></u>',
        'lost.notice.how3': '使用列表上方的 <b>快速预览</b> 按钮可通过照片快速浏览，或使用 <b>详细信息</b> 按钮以表格形式查看详细信息。',
        'lost.notice.how4': '如果没有照片，说明相关机构未上传照片（护照、身份证等<b>因涉及个人隐私，不上传照片</b>）。',
        'lost.notice.progress_title': '进度说明',
        'lost.notice.prog1': '<b>[已受理]</b> 遗失物信息已受理，正在核实中。',
        'lost.notice.prog2': '<b>[核实中]</b> 正在确认物品是否在保管处。',
        'lost.notice.prog3': '<b>[已取件]</b> 代理人已从保管处领取并保管该物品。',
        'lost.notice.prog4': '<b>[已寄出]</b> 物品已发送至您要求的地址。',
        ...
        'lost.region.incheon': '仁川机场',
        'lost.region.busan': '釜山',
        'modal.lost.city.incheon': '✈️ 仁川机场',
        ...
        'modal.lost.privacy.req': '[必填]',
        'modal.lost.privacy.agree': '同意收集和使用个人信息',
        'modal.lost.privacy.detail': '查看详情',
        'modal.lost.privacy.err': '请同意收集和使用个人信息。',
        ...
        'modal.lost.loc.police': '👮 警察局',
        'modal.lost.detail_loc.label': '详细位置',
        'modal.lost.detail_loc.ph':    '例: 3号登机口前, 星巴克涯月店...',
        'modal.lost.hotel.name': '酒店名称',
        'modal.lost.hotel.name.ph': 'Shilla Stay (英文)',
        'modal.lost.hotel.booker':'预订人姓名',
        'modal.lost.hotel.booker.ph': 'NingNing (英文)',
        'modal.lost.hotel.room': '房间号',
        'modal.lost.hotel.room.ph': '1024号',
        'modal.lost.hotel.dates':'入住/退房日期',
        'modal.lost.vehicle.no': '车牌号码',
        'modal.lost.vehicle.no.ph': '济州 12바 3456, 365路公交车',
        'modal.lost.vehicle.board_loc': '上车地点',
        'modal.lost.vehicle.board_loc.ph': '上车地点',
        'modal.lost.vehicle.alight_loc': '下车地点',
        'modal.lost.vehicle.alight_loc.ph': '下车地点',
        ...
        'proxy.modal.hotel_name.ph':   '例: Shilla Stay (英文)',
        'proxy.modal.hotel_booker':    '预订人姓名',
        'proxy.modal.hotel_booker.ph': '例: HONG GILDONG (英文)',
        'proxy.modal.item_name':       '物品名称',
        'proxy.modal.name':            '申请人姓名 (同护照)',
        'proxy.modal.name.ph':         '请输入姓名',
        'proxy.modal.contact':         '联系方式 (微信ID或电话)',
        ...
        'proxy.modal.passport':        '护照照片',
        'proxy.modal.item_photo':      '物品照片',
        'proxy.modal.reservation':     '酒店预订记录',
        'proxy.modal.mgmt_num':        '接待/管理号码 (机场, 警察局等)',
        'proxy.modal.mgmt_num.ph':     '请输入管理号码',
        'proxy.modal.wechat':          '收件人微信 ID',
        'proxy.modal.wechat.ph':       '请输入微信 ID',
        'proxy.modal.method':          '领取方式',
        'proxy.modal.method.delivery': '📦 快递配送',
        'proxy.modal.method.direct':   '🤝 直接领取',
        'proxy.modal.address':         '详细收货地址',
        'proxy.modal.address.ph':      '请输入详细地址 (酒店名称、房间号等)',
        'proxy.modal.direct.guide':    '工作人员将通过微信告知您保管位置及领取时间。',
        'proxy.modal.phone':           '联系电话',
        'proxy.modal.phone.ph':        '请输入联系电话',
        'proxy.modal.submit':          '提交代领申请',
        'proxy.modal.privacy_notice':  '由于代领标准升级，必须提供护照照片。无护照照片将无法在酒店或警察局代领。物品交付后，护照等个人信息将被立即删除。',
        'proxy.modal.step1.title':     '📍 物品存放在哪里？',
        'proxy.modal.step1.desc':      '请选择物品存放的场所。',
        'proxy.modal.step2.title':     '📄 请输入代领所需信息。',
        'proxy.modal.step3.title':     '📬 需要送到哪里？',
        ...
        'lost.tracker.status.hard':     '目前较难找回该物品。',
    ...
    ko: {
        ...
        'weather.past.tip.rainy_m10': '<strong>옷차림 팁:</strong> 10월 제주는 맑은 날이 많지만 예기치 않게 가을비가 내리고 나면 부쩍 쌀쌀해지니 우산과 함께 얇은 외투를 준비하세요.<br>비 오는 날 걷기 좋은 사려니숲길이나 곶자왈 산책은 색다른 매력이 있습니다.',
        ...
        'proxy.modal.desc':            '담당자가 물건을 수령하여 전달해드립니다.',
        'proxy.modal.case_id':         '케이스 번호',
        'proxy.modal.loc_type':        '물건이 보관된 장소',
        'proxy.modal.item_name':       '물품명',
        'proxy.modal.name':            '신청자 이름 (여권과 동일)',
        'proxy.modal.name.ph':         '이름을 입력해주세요',
        'proxy.modal.contact':         '연락처 (위챗 ID 또는 전화번호)',
        'proxy.modal.contact.ph':      '연락처를 입력해주세요',
        'proxy.modal.passport':        '여권 사진',
        'proxy.modal.item_photo':      '물건 사진',
        'proxy.modal.reservation':     '호텔 예약내역',
        'proxy.modal.mgmt_num':        '접수/관리번호 (공항, 경찰서 등)',
        'proxy.modal.mgmt_num.ph':     '관리번호를 입력해주세요',
        'proxy.modal.wechat':          '수령인 위챗 ID',
        'proxy.modal.wechat.ph':       '위챗 ID를 입력해주세요',
        'proxy.modal.method':          '수령 방법',
        'proxy.modal.method.delivery': '📦 배송 받기',
        'proxy.modal.method.direct':   '🤝 직접 수령',
        'proxy.modal.address':         '배송 주소',
        ...
        'nav.food':       '제주 맛집',
        'nav.course':     '추천 코스',
        'nav.reservation': '예약신청',
        'badge.maintenance': '점검중',

        // ── 예약신청 ──
        'res.type.beauty':     '미용실/네일',
        'res.type.restaurant': '식당',
        'res.type.activity':   '액티비티',
        'res.type.skin':       '피부과',
        'res.type.cloth':      '의류대여',
        'res.type.snap':       '스냅사진',
        'res.type.rental':     '물품대여',
        'res.type.other':      '기타',
        'res.back':            '뒤로',
        ...
        'lost.report.heic_err': '아이폰 고효율(HEIC) 사진은 지원하지 않습니다。\\n갤러리에서 화면을 캡처한 뒤, 캡처본(JPEG/PNG)으로 올려주세요!',
        ...
        'lost.modal.cta_report': '분실신고신청',
        'lost.modal.cta_proxy': '대리수령신청',
        'lost.notice.title': '분실물 센터 이용 안내',
        'lost.notice.howto': '사용 방법',
        'lost.notice.how1': '원하는 <b>지역</b>, <b>날짜</b>, <b>분류</b>를 선택 후 검색 버튼을 누르면 조회됩니다.',
        'lost.notice.how2': '내 물건이 없다면 상단의 <b>+ 분실물 등록</b> 버튼을 눌러 주세요. <u><b>즉시 분실장소, 해당업체에 연락 도와드립니다.</b></u>',
        'lost.notice.how3': '목록 상단의 <b>미리보기</b> 버튼으로 사진과 함께 빠르게 훑어보거나, <b>상세 정보</b> 버튼을 통해 자세한 정보를 표 형태로 확인할 수 있습니다.',
        'lost.notice.how4': '사진이 없는 경우는 해당 기관에서 등록하지 않은 것입니다 (여권, 신분증의 경우 <b>개인정보 보호를 위해 사진을 등록하지 않습니다</b>).',
        'lost.notice.progress_title': '진행 상황 안내',
        'lost.notice.prog1': '<b>[접수]</b> 분실물이 접수되어 정보를 확인 중입니다.',
        'lost.notice.prog2': '<b>[물품확인중]</b> 물건이 보관소에 있는지 확인하고 있습니다.',
        'lost.notice.prog3': '<b>[대리수령완료]</b> 대리인이 보관소에서 물품을 수령하여 보관 중입니다.',
        'lost.notice.prog4': '<b>[발송완료]</b> 요청하신 주소로 물품이 발송되었습니다.',
        ...
        'lost.notice.alert3': '버스나 택시 분실물은 등록되기까지 <b>7일 이상 소요</b>됩니다. 해당 운수회사로 문의하셔야 합니다.',
        ...
        'lost.region.incheon': '인천공항',
        'lost.region.busan': '부산',
        'modal.lost.city.incheon': '✈️ 인천공항',
        'lost.category':    '물품 분류 선택',
        'lost.report.btn':  '분실물을 못 찾으셨나요? 분실물 신고',
        ...
        'modal.lost.privacy.req': '[필수]',
        'modal.lost.privacy.agree': '개인정보 수집 및 이용 동의',
        'modal.lost.privacy.detail': '자세히 보기',
        'modal.lost.privacy.err': '개인정보 수집 및 이용에 동의해주세요.',
        ...
        'modal.lost.loc.police': '👮 경찰서',
        'modal.lost.detail_loc.label': '상세 위치',
        'modal.lost.detail_loc.ph':    '예: 3번 게이트 앞, 스타벅스 애월점...',
        'modal.lost.hotel.name': '호텔명',
        'modal.lost.hotel.name.ph': 'Shilla Stay (영문)',
        'modal.lost.hotel.booker':'예약자명',
        'modal.lost.hotel.booker.ph': 'NingNing (영문)',
        'modal.lost.hotel.room': '방 번호',
        'modal.lost.hotel.room.ph': '1024호',
        'modal.lost.hotel.dates':'체크인/체크아웃 날짜',
        'modal.lost.vehicle.no': '차량 번호',
        'modal.lost.vehicle.no.ph': '제주 12바 3456, 365번 버스',
        'modal.lost.vehicle.board_loc': '승차 장소',
        'modal.lost.vehicle.board_loc.ph': '승차 장소',
        'modal.lost.vehicle.alight_loc': '하차 장소',
        'modal.lost.vehicle.alight_loc.ph': '하차 장소',
        ...
        'proxy.modal.hotel_name.ph':   '예: Shilla Stay (영문)',
        'proxy.modal.hotel_booker':    '예약자명',
        'proxy.modal.hotel_booker.ph': '예: HONG GILDONG (영문)',
        'proxy.modal.item_name':       '물품명',
        'proxy.modal.item_name_opt':   '간략한 물품명 (선택)',
        'proxy.modal.item_photo_opt':  '물건 사진 (선택)',
        'proxy.modal.name':            '신청자 이름 (여권과 동일)',
        'proxy.modal.name.ph':         '이름을 입력해주세요',
        'proxy.modal.contact':         '연락처 (위챗 ID 또는 전화번호)',
        'proxy.modal.contact.ph':      '연락처를 입력해주세요',
        'proxy.modal.phone':           '연락처 (전화번호)',
        'proxy.modal.phone.ph':        '연락 가능한 전화번호를 입력해주세요',
        'proxy.modal.passport':        '여권 사진',
        'proxy.modal.item_photo':      '물건 사진',
        'proxy.modal.reservation':     '호텔 예약내역 캡처',
        'proxy.modal.room_num':        '투숙 방 번호 (선택)',
        'proxy.modal.room_num.ph':     '예: 301호',
        'proxy.modal.mgmt_num':        '분실물 접수/관리번호',
        'proxy.modal.mgmt_num.ph':     '관리번호를 입력해주세요',
        'proxy.modal.vehicle_info':    '차량 번호 또는 기사님 연락처',
        'proxy.modal.vehicle_info.ph': '예: 제주12바3456 또는 010-1234-5678',
        'proxy.modal.board_time':      '승하차 대략적인 시간 (선택)',
        'proxy.modal.board_time.ph':   '예: 오후 2시경',
        'proxy.modal.location_detail': '보관 장소 상세 설명',
        'proxy.modal.location_detail.ph':'장소와 상황을 상세히 적어주세요',
        'proxy.modal.wechat':          '위챗 ID',
        'proxy.modal.wechat.desc':     '위챗으로 연락하며 대리수령을 진행합니다.',
        'proxy.modal.wechat.ph':       '위챗 ID를 입력해주세요',
        'proxy.modal.address':         '최종 배송 상세 주소',
        'proxy.modal.address.ph':      '상세 주소(호텔명, 방 번호 등)를 적어주세요',
        'proxy.modal.submit':          '대리수령 신청하기',
        'proxy.modal.privacy_notice':  '대리수령 기준 강화에 따라 여권사진은 필수 서류입니다. 여권사진이 없을 시 호텔, 경찰서 등에서 물품 수령이 불가합니다. 수령 완료 후 여권사진 외 개인정보는 즉시 삭제됩니다.',
        'proxy.modal.step1.title':     '📍 어디서 찾아야 하나요?',
        'proxy.modal.step1.desc':      '물건이 보관되어 있는 장소를 선택해주세요.',
        'proxy.modal.step2.title':     '📄 수령에 필요한 정보를 적어주세요.',
        'proxy.modal.step3.title':     '📬 어디로 가져다 드릴까요?',
    ...
    en: {
        ...
        'nav.airport':    'Airport',
        'nav.lost':       'Lost & Found',
        'lost.home.search':   'Search',
        'lost.home.status':   'My Status',
        'lost.home.register': 'Report',
        'lost.home.proxy':    'Pickup',
        'lost.home.back':     'Back',
        ...
        // ── 예약신청 ──
        'res.type.beauty':     'Beauty/Nail',
        'res.type.restaurant': 'Restaurant',
        'res.type.activity':   'Activity',
        'res.type.skin':       'Skin Care',
        'res.type.cloth':      'Clothes Rental',
        'res.type.snap':       'Snap Photo',
        'res.type.rental':     'Item Rental',
        ...
        'res.store.label':     'Preferred Store (Optional)',
        ...
        'lost.modal.cta_report': 'Report Lost Item',
        'lost.modal.cta_proxy': 'Proxy Pickup Request',
        ...
        'lost.notice.how2': 'If you cannot find your item, click the <b>+ Register Lost Item</b> button at the top. <u><b>We will immediately assist you in contacting the lost location or related company.</b></u>',
        ...
        'lost.notice.how4': 'If there is no photo, it means the organization did not upload one (for passports and IDs, <b>photos are omitted to protect privacy</b>).',
        'lost.notice.progress_title': 'Status Guide',
        'lost.notice.prog1': '<b>[Received]</b> Lost item report has been received and is being verified.',
        'lost.notice.prog2': '<b>[Item Checking]</b> We are checking if the item is at the storage location.',
        'lost.notice.prog3': '<b>[Pickup Complete]</b> Our agent has collected the item and is keeping it safe.',
        'lost.notice.prog4': '<b>[Dispatch Complete]</b> The item has been sent to your requested address.',
        'lost.notice.prog5': '<b>[Direct Pickup]</b> The customer has picked up the item directly.',
        ...
        'lost.notice.alert3': 'It takes <b>7+ days</b> for items lost in buses/taxis to be registered. Please contact the transport company directly.',
        ...
        'lost.region.incheon': 'Incheon Airport',
        'lost.region.busan': 'Busan',
        'modal.lost.city.incheon': '✈️ Incheon',
        ...
        'modal.lost.upload_btn': 'Choose Photo',
        'modal.lost.upload_btn': 'Choose Photo',
        ...
        'modal.lost.loc.police': '👮 Police Station',
        ...
        'modal.lost.hotel.name.ph': 'Shilla Stay (English)',
        'modal.lost.hotel.booker':'Booking Name',
        'modal.lost.hotel.booker.ph': 'NingNing (English)',
        'modal.lost.hotel.room': 'Room Number',
        'modal.lost.hotel.room.ph': 'Room 1024',
        'modal.lost.hotel.dates':'Check-in / Check-out Dates',
        'modal.lost.vehicle.no': 'License Plate',
        'modal.lost.vehicle.no.ph': 'Jeju 12ba 3456, Bus 365',
        'modal.lost.vehicle.board_loc': 'Boarding Location',
        'modal.lost.vehicle.board_loc.ph': 'Boarding Location',
        'modal.lost.vehicle.alight_loc': 'Alighting Location',
        'modal.lost.vehicle.alight_loc.ph': 'Alighting Location',
        ...
        'modal.upsell.desc':     'However, just registering in the system may take a long time to find your item.<br><br>For only <b>10 RMB</b>, our dedicated staff will start an intensive 3-7 day search by actively contacting nearby hotels and taxis.',
        ...
        'proxy.modal.hotel_name.ph':   'e.g. Shilla Stay (English)',
        'proxy.modal.hotel_booker':    'Booker Name',
        'proxy.modal.hotel_booker.ph': 'e.g. HONG GILDONG (English)',
        'proxy.modal.item_name':       'Item Name',
        'proxy.modal.item_name_opt':   'Item Name (Optional)',
        'proxy.modal.item_photo_opt':  'Item Photo (Optional)',
        'proxy.modal.name':            'Applicant Name (Same as passport)',
        'proxy.modal.name.ph':         'Enter your name',
        'proxy.modal.contact':         'Contact (WeChat ID or Phone)',
        'proxy.modal.contact.ph':      'Enter your contact info',
        'proxy.modal.phone':           'Phone Number',
        'proxy.modal.phone.ph':        'Enter your phone number',
        'proxy.modal.passport':        'Passport Photo',
        'proxy.modal.item_photo':      'Item Photo',
        'proxy.modal.reservation':     'Hotel Reservation',
        'proxy.modal.room_num':        'Room Number (Optional)',
        'proxy.modal.room_num.ph':     'e.g. Room 301',
        'proxy.modal.mgmt_num':        'Management Number (Airport, Police, etc.)',
        'proxy.modal.mgmt_num.ph':     'Enter management number',
        'proxy.modal.vehicle_info':    'Vehicle No. or Driver Contact',
        'proxy.modal.vehicle_info.ph': 'e.g. 12가3456 or 010-1234-5678',
        'proxy.modal.board_time':      'Approx. Boarding/Alighting Time (Optional)',
        'proxy.modal.board_time.ph':   'e.g. Around 2 PM',
        'proxy.modal.location_detail': 'Location Details',
        'proxy.modal.location_detail.ph':'Please describe the location in detail',
        'proxy.modal.wechat':          'WeChat ID',
        'proxy.modal.wechat.desc':     'We will contact you via WeChat for proxy pickup.',
        'proxy.modal.wechat.ph':       'Enter your WeChat ID',
        'proxy.modal.address':         'Detailed Delivery Address',
        'proxy.modal.address.ph':      'Enter detailed address (hotel name, room number, etc.)',
        'proxy.modal.submit':          'Submit Pickup Request',
        'proxy.modal.privacy_notice':  'Due to stricter verification rules, a passport photo is required. Without it, pickup from hotels or police stations is not possible. Passport photos and personal information will be immediately deleted upon delivery completion.',
        'proxy.modal.step1.title':     '📍 Where should we pick it up?',
        'proxy.modal.step1.desc':      'Please select the location where the item is stored.',
        'proxy.modal.step2.title':     '📄 Please enter pickup information.',
        'proxy.modal.step3.title':     '📬 Where should we deliver it?',
