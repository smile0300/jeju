...
async function onRequest(context) {
  ...
  if (pathname === "/api/hallasan-status") {
    try {
      ...
      const stripTags = /* @__PURE__ */ __name((str) => decodeHtmlEntities((str || "").replace(/<[^>]*>?/gm, "").replace(/&nbsp;/g, "").trim()), "stripTags");
      const results = [];
      let match2;
...
// ../.wrangler/tmp/pages-KCJpz5/functionsRoutes-0.09207644015452177.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-Bv6Wsq/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Bv6Wsq/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5811123710198661.mjs.map
