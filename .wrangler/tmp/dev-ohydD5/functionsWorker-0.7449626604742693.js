...
// .wrangler/tmp/pages-JHIDQr/functionsWorker-0.7449626604742693.mjs
...
async function onRequest3(context) {
  ...
  try {
    ...
    const decodeHtmlEntities = /* @__PURE__ */ __name2((str) => str.replace(/&#(\d+);/g, (match3, dec) => String.fromCharCode(dec)), "decodeHtmlEntities");
    const stripTags = /* @__PURE__ */ __name2((str) => decodeHtmlEntities((str || "").replace(/<[^>]*>?/gm, "").replace(/&nbsp;/g, "").replace(/\s+/g, " ").trim()), "stripTags");
    const results = [];
    let match2;
...
// .wrangler/tmp/bundle-j4ivdV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-j4ivdV/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7449626604742693.js.map
