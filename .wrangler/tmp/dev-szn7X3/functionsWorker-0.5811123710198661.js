...
// .wrangler/tmp/pages-KCJpz5/functionsWorker-0.5811123710198661.mjs
...
async function onRequest(context) {
  ...
  if (pathname === "/api/hallasan-status") {
    try {
      ...
      const stripTags = /* @__PURE__ */ __name2((str) => decodeHtmlEntities((str || "").replace(/<[^>]*>?/gm, "").replace(/&nbsp;/g, "").trim()), "stripTags");
      const results = [];
      let match2;
...
// .wrangler/tmp/bundle-RebSgC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RebSgC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5811123710198661.js.map
